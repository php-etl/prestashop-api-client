...
interface ProductOptionsApiInterface extends GettableResourceInterface, ListableResourceInterface, CreatableResourceInterface, UpdatableResourceInterface, UpsertableResourceInterface
{
}
